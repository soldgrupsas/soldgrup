-- Restore pgcrypto calls to public schema (Supabase installs pgcrypto objects in public)
...
begin
  ...
  values (
    'openai_api_key',
    public.pgp_sym_encrypt(normalized_key, secret, 'cipher-algo=aes256'),
    suffix,
...
begin
  ...
  return public.pgp_sym_decrypt(encrypted_value, secret);
end;
$function$;
