-- Use schema-qualified pgcrypto functions within encryption helpers
...
begin
  ...
  values (
    'openai_api_key',
    pgcrypto.pgp_sym_encrypt(normalized_key, secret, 'cipher-algo=aes256'),
    suffix,
...
begin
  ...
  return pgcrypto.pgp_sym_decrypt(encrypted_value, secret);
end;
$function$;
